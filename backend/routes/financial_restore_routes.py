...
def register_financial_restore_routes(application, *, token_required, permission_required):
    ...
    @token_required
    @permission_required("summary.financial")
    def get_financial_dashboard(business_id):
        ...
        summary = {
            ...
            "financial_debt_overdue_total": _safe_round(current_financial_summary.get("overdue_total")),
            "financial_debt_due_today_total": _safe_round(current_financial_summary.get("due_today_total")),
            "financial_debt_due_soon_total": _safe_round(current_financial_summary.get("due_soon_total")),
            "financial_debt_active_count": int(float(current_financial_summary.get("active_count") or 0)),
        }
        previous_period = {
