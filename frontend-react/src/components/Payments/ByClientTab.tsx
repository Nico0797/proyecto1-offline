  ...
  return (
    <>
      ...
      <div className="lg:hidden space-y-3">
        {data.map((client) => (
            <div key={client.customerId} className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 active:scale-[0.99] transition-transform" onClick={() => onSelectClient(client)}>
                   ...
                   <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-xs text-gray-500 truncate">
                                {client.maxDaysOverdue > 0 ? `${client.maxDaysOverdue} días vencido` : 'Al día'}
                            </p>
                        </div>
                   </div>
               ...
               <div className="flex justify-between items-end border-t border-gray-50 dark:border-gray-700/50 pt-3">
                    <div>
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white">${client.totalDebt.toLocaleString()}</p>
                    </div>
