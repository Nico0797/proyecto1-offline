  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
      <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
        ...
        <div className="text-lg font-bold text-gray-900 dark:text-white">{totalCustomers}</div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
        ...
        <div className="text-lg font-bold text-gray-900 dark:text-white">{customersWithDebt}</div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-3 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
        ...
        <div className="text-lg font-bold text-gray-900 dark:text-white">{activeCustomers}</div>
      </div>
    </div>
  );
};
