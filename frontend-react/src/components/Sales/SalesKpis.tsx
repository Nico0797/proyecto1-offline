    ...
    <>
      ...
      {open && (
        <div className="grid grid-cols-2 gap-2 mb-2 md:hidden">
          <div className="app-soft-surface flex items-center justify-between rounded-lg p-2 backdrop-blur">
            <div className="flex items-center gap-2">
          ...
          <div className="app-soft-surface col-span-2 flex items-center justify-between rounded-lg p-2 backdrop-blur">
            <div className="flex items-center gap-2">
      ...
      <div className="hidden md:grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        <div className="app-stat-card rounded-xl p-3">
