...
export const PeriodFilter: React.FC<PeriodFilterProps> = ({ 
  ...
  const handlePresetChange = (preset: PeriodPreset) => {
    if (preset === 'custom') {
      const newRange = { ...internalRange, preset: 'custom' };
  ...
  return (
    <div className={`relative ${className}`} ref={containerRef}>
      ...
      {isOpen && (
        <div className="absolute top-full mt-2 left-0 w-64 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 z-50 overflow-hidden">
